...
const ServiceResolution = () => {
  // State management for image swapping
  ...
  return (
    <div className="w-[700px] bg-[#00262A] text-white rounded-lg p-4">
      ...
      <div className="flex mb-4 gap-6">
        ...
        <div className="flex flex-col items-start justify-between ml-4">
          ...
          <div>
            ...
            <select className="w-40 p-2 rounded-md bg-white text-black">
      ...
      <div className="flex justify-end space-x-4">
        <button className="bg-[#1E1E1E] px-5 py-2 text-sm rounded-md text-white border border-transparent hover:bg-transparent hover:border-[#1E1E1E] hover:text-[#1E1E1E] transition duration-300">
            Cancel
        </button>
        <button className="bg-[#E6F4EA] px-5 py-2 text-sm rounded-md text-[#004B23] border border-transparent hover:bg-transparent hover:border-[#004B23] hover:text-[#004B23] transition duration-300">
            Save Changes
        </button>
        </div>
    </div>
