  ...
  return (
      ...
      <div className="relative w-48 h-64 perspective-1000">
        ...
        >
          {/* Front Side */}
          <div
            className="absolute w-full h-full bg-[#6AA6A6] text-white rounded-lg p-4 shadow-lg backface-hidden cursor-pointer"
            onClick={handleFlip}
          >
          ...
          {/* Back Side */}
          <div
            className="absolute w-full h-full bg-[#4F9D9D] text-white rounded-lg p-4 shadow-lg backface-hidden rotate-y-180 cursor-pointer"
            onClick={handleFlip}
          >
